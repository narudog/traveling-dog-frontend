...
const Airplane = ({ isFlying }: AirplaneProps) => {
    useEffect(() => {
        if (isFlying) {
            gsap.timeline()
                // 활주로 줄무늬 애니메이션
    ...
    return (
        <div className={styles.container}>
            <div className={styles.runway}>
                <div className={`${styles.runwayStripes} runwayStripes`}></div>
            </div>
            <svg className={`${styles.airplane} airplane`} viewBox="0 0 512 512" xmlSpace="preserve" xmlns="http://www.w3.org/2000/svg" xmlnsXlink="http://www.w3.org/1999/xlink">
